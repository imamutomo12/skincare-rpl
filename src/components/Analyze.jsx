    ...
    <div className="flex h-screen">
      ...
      <div className="flex-grow w-min overflow-y-auto justify-center h-screen bg-tiga">
        ...
        <div className="flex justify-between items-center p-5">
          ...
          {/* Optionally, add any header actions here */}
        </div>
        <hr className="h-0.5 bg-hitam/20" />

        <div className="mx-5 p-7">
          {/* Photo Quality Guidelines Section */}
          <div className="bg-empat rounded font-jura p-5 shadow-md mb-7 max-w-3xl mx-auto">
            <h2 className="text-xl font-bold mb-3 text-hitam">
              Photo Quality Guidelines
            </h2>
            <ul className="list-disc list-inside mb-3 text-hitam">
              <li>
                <strong>Format:</strong> JPG (JPEG)
              </li>
              <li>
                <strong>Size (Dimensions):</strong> Between 200×200 and
                4096×4096 pixels.
              </li>
              <li>
            ...
            <div className="flex  font-jura flex-col md:flex-row gap-5">
              ...
              <div className="flex-1 border p-3 rounded">
                ...
                <div className="h-40 bg-red-100 flex items-center justify-center">
                  <p className="text-sm text-red-800">
                    Blurry, poorly lit face, occlusions, or incorrect
                    dimensions.
                  </p>
                </div>
              </div>
          ...
          <div className="flex font-jura flex-col items-center justify-center gap-4 p-5 bg-empat rounded-lg shadow-md max-w-3xl mx-auto">
            <div className="relative w-64 h-64 border-2 border-dashed border-telorasin rounded-lg flex items-center justify-center">
              <input
                type="file"
                accept="image/*"
              ...
              {previewUrl ? (
                ...
                <span className="text-hitam text-center p-4">
                  Click to upload a face photo <br />
                  (JPEG, PNG)
                </span>
              )}
            </div>
            ...
            {loading && (
              <div className="flex items-center gap-2 text-hitam">
                <svg
                  className="animate-spin h-5 w-5 text-hitam"
            ...
            {result && (
              <div className="mt-4 p-4 bg-taro rounded-lg shadow">
                <h2 className="text-xl font-bold mb-2 text-hitam">
                  Analysis Results:
                </h2>
                <p className="text-lg text-hitam">
                  Your Skin Type:{" "}
            ...
            <button
              ...
              className="mt-3 px-4 py-2 bg-dongker text-empat rounded hover:bg-hitam transition"
            >
              Recommend Product
            </button>
          </div>
